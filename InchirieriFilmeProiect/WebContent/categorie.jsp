...
<body onload="loadDoc()">
							...
							<div class="row">
								<div class=" col-sm-12   " id="content">
									...
									<div class="box new-products">
										<div>
											<h3>
												<i class="fa fa-star"></i> Cele mai noi filme
											</h3>
										</div>
										<br>
										<br>
	...
	<script>
        ...
        function loadDoc() {
			  ...
			  var res = url.split("?");
        	  xhttp.open("GET", "http://localhost:8080/ProiectInchirieriFilme/rest/load-movies/?"+res[1], true);
        	  xhttp.send();
        	}
        
        function show_trailer(id_tag,player_id)
        {
        ...
        function hide_trailer(id_tag,player_id)
        {
