						...
						<div class="container">
							...
							<div class="row">
								<div class=" col-sm-12   " id="content">
									...
									<div class="box new-products" id="formRegister">
										<div align="center" style="padding: 30px 0 0 0;">
											<h1>
												<i class="fa fa-users"></i> Inregistrare cont
											</h1>
										</div>
										<br> <br>
															...
															<tbody>
																<tr>
																	<td>
																		<div class="form-group">
																			<label class="control-label col-sm-5"><span
																				class="required">*</span> User Name:</label>
																			<div class="controls col-sm-7">
																				<input placeholder="User Name" class="q1"
																...
																<tr>
																	<td>
																		<div class="form-group">
																			...
																			<div class="controls col-sm-7">
																				<input placeholder="E-mail" class="q1" type="text"
																					id="email_sign" name="email" value="">
																			</div>
																		</div>
																	</td>
																</tr>
																<tr>
																	<td>
																		<div class="form-group">
																			<label class="control-label col-sm-5"><span
																				class="required">*</span> Telefon:</label>
																			<div class="controls col-sm-7">
																				<input class="q1" type="text" id="telefon"
																					name="telefon" value="" placeholder="Telefon">
																			</div>
																		</div>
																	</td>
																</tr>
																...
																<tr>
																	<td>
																		<div class="form-group">
																			<label class="control-label col-sm-5"><span
																				class="required">*</span> Parola:</label>
																			<div class="controls col-sm-7">
																				<input class="q1" type="password" id="parola_1"
																					name="parola" placeholder="Minim 4 caractere"
																					value="">
																			</div>
																		</div>
																	</td>
																...
																<tr>
																	<td>
																		<div class="form-group">
																			<label class="control-label col-sm-5"><span
																				class="required">*</span> Confirmare Parola:</label>
																			<div class="controls col-sm-7">
																				<input class="q1" type="password" id="parola_2"
																					name="parola_2" value=""
													...
													<div class="buttons" align="center">
														<div class="cart">
															<a class="btn btn-danger btn-sm"
																onclick="verifica_date()" title="Submit"><span>Submit</span></a>
