            ...
            <div class="swipe">
                ...
                <div class="swipe-menu">
                    <ul class="links">
                        ...
                        <li><a class="" href="?route=checkout/checkout"><i class="fa fa-check"></i>Checkout</a></li>
                        <li><a href="?route=account/register"><i class="fa fa-user"></i>Create an account</a></li>
                        <li class="login_h"><a href="?route=account/login"><i class="fa fa-lock"></i>Login</a></li>
                    </ul>
                    <div class="language header-button">
                        ...
                        <form action="?route=module/language" method="post" enctype="multipart/form-data">
                            <div class="ul">
			...
			<div id="shadow">
				...
				<section>
					...
					<form id="categorieFilm" method="get" action="categorie.jsp">
						...
						<div id="menu">
							<ul class="sf-menu">
								<li class="cat_1"><a href="#" onclick="getCat('actiune');"><i
										class="fa fa-play-circle-o"></i> Actiune</a></li>
								<li class="cat_2"><a href="#" onclick="getCat('comedie');"><i
										class="fa fa-play-circle-o"></i> Comedie</a></li>
								<li class="cat_3"><a href="#" onclick="getCat('drama');"><i
										class="fa fa-play-circle-o"></i> Drama</a></li>
								<li class="cat_4"><a href="#" onclick="getCat('horror');"><i
										class="fa fa-play-circle-o"></i> Horror</a></li>
								<li class="cat_5"><a href="#" onclick="getCat('sf');"><i
										class="fa fa-play-circle-o"></i> S.F</a></li>
								<li class="cat_6"><a href="#" onclick="getCat('animatie');"><i
										class="fa fa-play-circle-o"></i> Animatie</a></li>
							</ul>
							<div class="clear"></div>
						</div>
					</form>
						...
						<div class="container">
							...
							<div class="row">
								<div class=" col-sm-12   " id="content">
										...
										<div class="box-content">
											<div class="box-product">
												<div class="row" id="demo">
													...
													<h1 style="margin-left: 90px;"><i class="fa fa-opencart"></i> Cos Cumparaturi! </h1>
													<!-- parte dinamica prima pagina -->
									...
									<h1 style="display: none;">Look &amp; Listen online store</h1>
								</div>
								<div class="clear"></div>
							</div>
						</div>
	...
	function trimiteComanda()
	{
		...
		xhttp.onreadystatechange = function() {
			if (xhttp.readyState == 4 && xhttp.status == 200) {
				...
				alert('Cererea dvs. a fost inregistrata cu succes.\n Unul dintre colegii nostri va prelua comanda in cel mai scurt timp.\n Va multumim.')
				window.location.href = "http://localhost:8080/ProiectInchirieriFilme/";
			}
		};
		xhttp.open("GET","check-out/", true);
	...
	window.onload = function() {
		...
		xhttp.onreadystatechange = function() {
			if (xhttp.readyState == 4 && xhttp.status == 200) {
				 ...
				 {
					session_loged= false;
					$('#cosCumparaturi').empty();
					document.getElementById("cosCumparaturi").innerHTML = "<div style='margin-left:100px;'>Cosul dumneavoastra este gol. Pentru a putea adauga si vizualiza produsele din cos, trebuie sa va autentificati.<br> Va multumim pentru intelegere.</div>";
				 ...
				 else
				 {
					 session_loged = true;
					 $('#cosCumparaturi').empty();
					 document.getElementById("cosCumparaturi").innerHTML = xhttp.responseText;
				 }
			}
		};
		xhttp.open("GET","load-cos/", true);
		xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		xhttp.send();
